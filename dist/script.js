...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      phoneIntupts = document.querySelectorAll('input[name="user_phone"]');
  phoneIntupts.forEach(function (item) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.stile.overflow = "hidden"; // document.body.classList.add('modal-open');
      });
    });
    close.addEventListener('click', function () {
      ...
      document.body.stile.overflow = ""; // document.body.classList.remove('modal-open');
    });
